  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-4">
      <a
        ...
        className="group flex h-12 w-40 items-center justify-center gap-2.5 rounded-full border border-platinum/20 text-xs font-medium uppercase tracking-[0.15em] text-ivory transition-all duration-300 hover:border-champagne hover:bg-champagne/10 hover:text-champagne hover:shadow-[0_0_16px_rgba(214,179,106,0.25)] active:scale-[0.97]"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group flex h-12 w-40 items-center justify-center gap-2.5 rounded-full border border-platinum/20 text-xs font-medium uppercase tracking-[0.15em] text-ivory transition-all duration-300 hover:border-emerald hover:bg-emerald/10 hover:text-emerald hover:shadow-[0_0_16px_rgba(14,94,85,0.3)] active:scale-[0.97]"
      >
