...
const en: Dictionary = {
  ...
  errors: {
    ...
    invalidDates: "Choose a valid date range.",
    ...
    missingRoom: "Select a room.",
    invalidPromoCode: "Enter a valid promo code.",
    invalidVoucher: "Invalid voucher.",
    capacityExceeded: "This room can't accommodate that many guests.",
    minNights: "This room requires a minimum stay of {{nights}} nights.",
  },
  forms: {
    submit: "Submit",
