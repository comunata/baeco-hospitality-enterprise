const ro = {
  ...
  portal: {
    ...
    auth: {
      identifierLabel: "Email sau telefon",
      identifierPlaceholder: "nume@exemplu.com sau 07xxxxxxxx",
      codeLabel: "Cod rezervare",
      codePlaceholder: "BD-XXXXXX",
      verify: "Accesează rezervarea",
  ...
  errors: {
    ...
    invalidDates: "Alege o perioadă validă.",
    ...
    missingFirstName: "Completează prenumele.",
    missingLastName: "Completează numele.",
    missingEmail: "Completează emailul.",
    missingPhone: "Completează telefonul.",
    missingRoom: "Selectează camera.",
    invalidPromoCode: "Introdu un cod promoțional valid.",
    invalidVoucher: "Voucher invalid.",
    capacityExceeded: "Camera nu poate găzdui atât de mulți oaspeți.",
    minNights: "Această cameră necesită o ședere minimă de {{nights}} nopți.",
  },
  forms: {
    submit: "Trimite",
