...
export const seedServices: ExtraService[] = [
  ...
  { id: "svc-half-board", slug: "half-board", name: { ro: "Demipensiune", en: "Half board" }, description: { ro: "Mic dejun și cină incluse zilnic.", en: "Daily breakfast and dinner included." }, price: 45, chargeType: "per_person", active: true },
  { id: "svc-romantic-dinner", slug: "romantic-dinner", name: { ro: "Cină romantică", en: "Romantic dinner" }, description: { ro: "Cină privată la lumina lumânărilor, meniu în 4 feluri.", en: "Private candlelit dinner, 4-course menu." }, price: 95, chargeType: "per_booking", active: true },
  { id: "svc-pet-fee", slug: "pet-fee", name: { ro: "Animal de companie", en: "Pet fee" }, description: { ro: "Taxă pentru animale de companie (max 10 kg), include kit de bun venit.", en: "Pet fee (max 10 kg), includes a welcome kit." }, price: 15, chargeType: "per_night", active: true },
